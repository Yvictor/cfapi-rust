fn main() -> miette::Result<()> {
    ...
    let path_cfapi_include = std::path::PathBuf::from("cfapi-cpp-linux-1.7.0.1/include");
    // let mut b =
    ...
    // println!("cargo:rustc-link-search=./cfapi-cpp-linux-1.7.0.1/lib");
    // println!("cargo:rustc-link-search=static=./cfapi-cpp-linux-1.7.0.1/lib");
    println!("cargo:rustc-link-search=native=./cfapi-cpp-linux-1.7.0.1/lib");
    println!("cargo:rustc-link-search=native=./src/cfapi/cfapi-cpp-linux-1.7.0.1/lib");
    println!("cargo:rustc-link-lib=dylib=cfapi");
    println!("cargo:rustc-link-search=native=./cfapi-cpp-linux-1.7.0.1/dbcapi");
    println!("cargo:rustc-link-search=native=./src/cfapi/cfapi-cpp-linux-1.7.0.1/dbcapi");
